...
def test_multiple_jobs_submission(scheduler, region, pcluster_config_reader, clusters_factory, test_datadir, scheduler_commands):
    ...
    scheduler_commands = scheduler_commands(remote_command_executor)
