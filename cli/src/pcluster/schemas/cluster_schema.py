...
class ByosEventsSchema(BaseSchema):
    ...
    head_init_environment = fields.Nested(ByosEventSchema, metadata={"update_policy": UpdatePolicy.UNSUPPORTED})
    ...
    compute_init_environment = fields.Nested(ByosEventSchema, metadata={"update_policy": UpdatePolicy.UNSUPPORTED})
