...
class ByosClusterSharedArtifact(Resource):
    ...
    def _register_validators(self):
        self._register_validator(UrlValidator, url=self.source, fail_on_https_error=True)
...
class ByosEvents(Resource):
    ...
    def __init__(
        self,
        head_init_environment: ByosEvent = None,
        head_configure: ByosEvent = None,
        head_finalize: ByosEvent = None,
        compute_init_environment: ByosEvent = None,
        ...
        **kwargs,
        ...
        super().__init__(**kwargs)
        self.head_init_environment = head_init_environment
        self.head_configure = head_configure
        self.head_finalize = head_finalize
        self.compute_init_environment = compute_init_environment
