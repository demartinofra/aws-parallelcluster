...
default['node_type'] = ENV['NODE_TYPE']

default['pcluster']['cluster_name'] = ENV['PCLUSTER_CLUSTER_NAME']
default['pcluster']['local_dir'] = ENV['PCLUSTER_LOCAL_BYOS_DIR']
default['pcluster']['shared_dir'] = ENV['PCLUSTER_SHARED_BYOS_DIR']
...
default['pcluster']['cfn_stack_outputs_file'] = ENV['PCLUSTER_BYOS_CFN_SUBSTACK_OUTPUTS']
