...
echo "Handling event: HeadInitEnvironment"
...
/opt/parallelcluster/pyenv/bin/pyenv virtualenv --force 3.9.7 byos
...
#chef-client -z -o slurm_plugin_cookbook::head_node_config --log-level debug
