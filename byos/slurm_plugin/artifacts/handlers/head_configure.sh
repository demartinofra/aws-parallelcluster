...
source /home/byos/.pyenv/versions/3.9.7/envs/scheduler_plugin/bin/activate
...
sudo -E cinc-client -z -o slurm_plugin_cookbook::slurm_install --log-level info --force-formatter
